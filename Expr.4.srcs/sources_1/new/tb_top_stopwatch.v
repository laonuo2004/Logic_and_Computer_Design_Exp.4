...
// 功能: 用于仿真验证 top_stopwatch 模块，检测状态图的11条关键路径。
//       仿真速度已加速1000倍。
//------------------------------------------------------------------------------
`timescale 1ns / 1ps
...
module tb_top_stopwatch;
    ...
    initial begin
        ...
        // =========================================================================
        // 第二部分：测试正常的运行与暂停功能 (对应红色数字 2, 3, 4)
        // =========================================================================
        ...
        // =========================================================================
        // 第五部分：测试报警功能与该状态下的复位 (对应红色数字 9, 10, 11)
        // =========================================================================
        ...
        #(200 * 1000 * CLK_PERIOD); // 观察报警状态200ms
